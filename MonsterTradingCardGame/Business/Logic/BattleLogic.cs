...
public class BattleLogic
{
    public int DetermineRoundWinner(Card card1, Card card2)
    {
		...
		if (card2.Name.Contains("Wizzard") && card1.Name.Contains("Ork"))
			return 2;
		if (card1.Name.Contains("Knight") && card2 is SpellCard spellCard2 && spellCard2.ElementType == ElementType.Water)
			return 2;
		if (card2.Name.Contains("Knight") && card1 is SpellCard spellCard1 && spellCard1.ElementType == ElementType.Water)
			return 1;
